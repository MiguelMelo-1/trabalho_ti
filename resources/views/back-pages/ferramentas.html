        ...
        <div class="sidebar pe-2 pb-3 ps-2 mt-3">
            <nav class="navbar bg-transparente navbar-dark rounded">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="ferramentas.html" class="nav-item nav-link active"><i class="fa fa-toolbox me-2"></i>Ferramentas</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="trabalhos_pendentes.html" class="nav-link dropdown-item">Pendentes</a>
