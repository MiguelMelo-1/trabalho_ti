        ...
        <div class="flex items-center h-screen py-5 xl:py-0 ">
            <div class="mx-auto  px-5 sm:px-8 py-8 rounded-md shadow-md w-full sm:w-3/4 lg:w-2/4 xl:w-auto"
                ...
                <div class="intro-x mt-3">
                    <form id="login-form">
                        ...
                        <input id="password" type="password"
                            class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Palavra-passe">
                ...
                <div class="intro-x mt-5 text-slate-400 text-center">
                    Ao prosseguir está a concordar com os nossos<br> <a class="text-agrodireto-3"
                        href="#">Termos e Condições</a> & <a class="text-agrodireto-3"
                ...
                <div class="flex text-slate-600 mt-5">
                    <div class="flex w-full justify-center">
                        <i class="text-center w-5 h-5 mr-2 text-white fa-regular fa-envelope"></i><label
