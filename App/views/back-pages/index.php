...
<body class="">
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            <!-- Navbar Start -->
            <nav class="navbar navbar-expand bg-transparente navbar-dark px-4 py-0 rounded mt-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-transparente rounded d-flex align-items-center justify-content-between p-4">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-transparente text-center rounded p-4">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-transparente rounded p-4">
