...
<head>
    <meta charset="utf-8">
    <title>CMHandyMans - Criar Orçamento</title>
    ...
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="criar_orcamento.html" class="nav-link dropdown-item active">Criar Orçamento</a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <div class="content">
            ...
            <form>
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-transparente rounded p-4">
                        ...
                        <div class="row g-3 mt-5">
                            <div class="col-6">
                                <label for="inputNome" class="form-label">Nome <i class="text-danger">*</i></label>
                                <input type="text" class="form-control" id="inputNome" placeholder="Insira o nome" required>
                            </div>
                            <div class="col-6">
                                <label for="inputNif" class="form-label">NIF <i class="text-danger">*</i></label>
                                <input type="number" class="form-control" id="inputNif" aria-describedby="nifHelp"
                                    placeholder="Insira o NIF" pattern="[0-9]{9}" required>
                                <div id="nifHelp" class="form-text text-light">Aceita: 0...9</div>
                            </div>
                        </div>
                        <div class="row g-3 mt-5">
                            <div class="col-6">
                                <label for="inputMorada" class="form-label">Morada <i class="text-danger">*</i></label>
                                <input type="text" class="form-control" id="inputMorada" placeholder="Insira a morada"
                                    required>
                            </div>
                            <div class="col-6">
                                <label for="inputCodPostal" class="form-label">Cód.Postal <i
                                        class="text-danger">*</i></label>
                                <input type="text" class="form-control" id="inputCodPostal"
                                    aria-describedby="nifcodPostalFormat" placeholder="Insira o cód. postal"
                                    maxlength="8" minlength="8" required>
                                <div id="codPostalFormat" class="form-text text-light">Formato: 1234-123</div>
                            </div>
                        </div>
                        <div class="row g-3 mt-5">
                            <div class="col-4">
                                <label for="inputLocalidade" class="form-label">Localidade <i
                                        class="text-danger">*</i></label>
                                <input type="text" class="form-control" id="inputLocalidade"
                                    placeholder="Insira a Localidade" required>
                            </div>
                            <div class="col-4">
                                <label for="inputEmail" class="form-label">Email <i class="text-danger">*</i></label>
                                <input type="email" class="form-control" id="inputEmail" aria-describedby="emailHelp"
                                    placeholder="Insira o Email" required>
                                <div id="emailHelp" class="form-text text-light">Caso cliente não ter email inserir:
                                    null@gmail.com</div>
                            </div>
                            <div class="col-4 ">
                                <label for="inputTlm" class="form-label">Telemóvel <i class="text-danger">*</i></label>
                                <input type="number" class="form-control" id="inputTlm" aria-describedby="tlmFormat"
                                    placeholder="Insira o cód. postal" pattern="[0-9]{9}" required>
                                <div id="tlmFormat" class="form-text text-light">Formato: 123456789</div>
                            </div>
                        </div>
                        <div class="text-end mt-5">
                            <input type="button" name="limpar" value="Limpar Cliente" id="limparCliente"
                ...
                <!-- //TODO: Criar divisão de adicionar o tipo de trabalho e a sua descrição -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <button type="submit" class="btn btn-success"><i
                                            class="fa fa-arrow-up-from-bracket mx-2"></i>Submeter</button>
                                </div>
                            </div>
                    </div>
                </div>
